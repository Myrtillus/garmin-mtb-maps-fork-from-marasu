...
mv /osm-data/finland-latest.osm.pbf /home/render/data.osm.pbf
#mv /osm-data/islas-baleares-latest.osm.pbf data.osm.pbf
#mv /osm-data/spain-latest.osm.pbf data.osm.pbf

cd /home/renderer

create_map 22.80 61.00 25.00 62.20 TK "Tampere region" TK_Tampere_v2 TK_Tampere 88880001 tk_tre.img

#create_map 2.1 39.2 3.6 40 TK "Mallorca region" TK_Tampere_v2 TK_Mallorca 88880002 mallorca.img
#create_map 1.5 37 4 42 TK "Mallorca region" TK_Tampere_v2 TK_Mallorca 88880002 mallorca.img
